...
base_dir = './'
target_dir = '../../grading-3/KarinaMankevic'
...
# get_ipython().system('pip3 install --quiet openml ')
...
# # get_ipython().system('python3 drive/My\\ Drive/Web_Info_Retrieval/assignment-3-KarinaMankevic/verify.py')
